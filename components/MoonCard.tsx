...
const MoonCard: React.FC<MoonCardProps> = ({ data, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10 flex flex-col relative overflow-hidden aspect-square cursor-pointer active:scale-95 transition-transform"
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10">
        <MoonVisual phase={phase} size={90} />
